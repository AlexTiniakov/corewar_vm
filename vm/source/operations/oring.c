...
/*   Updated: 2018/09/28 21:17:39 by dskrypny         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	extended_oring(unsigned int arg[3], int codage)
{
	int		shift;
	int		i;
	int		result;
